...
const searchButtonVariants = {
  initial: { scale: 1, boxShadow: 'none', color: 'var(--primary-color)' },
  hover: { scale: 1.15, boxShadow: '0 0 8px var(--primary-color)', color: 'var(--primary-color)' },
  tap: { scale: 0.95, boxShadow: '0 0 4px var(--primary-color)', color: 'var(--primary-light)' }
};
