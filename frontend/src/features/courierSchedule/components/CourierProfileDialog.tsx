...
import { updateUserProfileThunk } from '@shared/store/userSlice/userThunks';
import { updateSeniorityStatus } from '@shared/store/userSlice/userThunks';
...
import { ShiftSlotLocal } from './types';
