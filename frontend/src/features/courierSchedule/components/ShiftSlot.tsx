...
import { deleteShiftAsSenior } from '@features/courierSchedule/services/courierApi';
import { useAppDispatch } from '@/shared/store/hooks';
import { removeShiftLocally } from '@features/courierSchedule/store/shiftsSlice/shiftsSlice';
import { cancelShift } from '../store/shiftsSlice/shiftsThunks';
...
const ShiftSlotComponent: React.FC<ShiftSlotProps> = React.memo(({
    ...
    const handleDeleteSelf = useCallback(async () => {
        ...
        try {
            await dispatch(cancelShift({ shiftId: shiftDbId, userId: String(currentUserId) })).unwrap();
