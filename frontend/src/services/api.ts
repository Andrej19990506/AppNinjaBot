...
import { 
    ...
    getChatInventory, 
    updateChatInventory, 
    getItemHistory as inventoryGetItemHistory // Переименовываем для ясности
    // getChefChats // Если нужно, раскомментировать и импортировать
} from './inventoryApi';
// Убеждаемся, что этот импорт закомментирован или удален
// import { userApi } from './userApi';
// import { writeOffApi } from './writeOffApi'; // Раскомментировать, если writeOffApi в отдельном файле
